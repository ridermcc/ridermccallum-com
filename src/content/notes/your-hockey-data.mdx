...
The pipeline works today. A player types their name, confirms a date of birth, and watches the profile build. It is not finished: the EP parser still meets edge cases, the news judge runs a touch conservative, the YouTube finder misses channels that don't use a full name.
