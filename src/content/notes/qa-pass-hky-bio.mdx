...
I built the [onboarding walkthrough](./claude-loop) yesterday. The loop landed nine of ten issues cleanly and I fed the last one back into Claude to iterate on.
