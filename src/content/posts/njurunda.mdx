export const metadata = {
  ...
  summary:
    "My experience off-season training in Sweden.",
  date: "2026-07-13",
...
It had character. A real small town barn. Cold, hard ice, concrete floors in the hallway out to the sheet, staff that loves the rink, and crawling with rink rats.
...
The people were incredibly welcoming and kind. There's a notion around Swedish people being cold, or closed off, but this wasn't my experience. 

Strangers quickly became my friends. Maybe this is the hockey world doing its magic as well, I'm not totally sure.

Making the decision to come to Sweden without a set plan to skate was a bit unnerving, but with enough clarity and drive on what you need to accomplish, it will work out.
